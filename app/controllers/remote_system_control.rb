...
class RemoteControl
  ...
  def this.send_message(message_body, dev_id)
  ...
  def this.sendMessageWithResponse(message_body, dev_id)
  ...
  def this.write_data_entry(location, value)
  ...
  def this.read_data_entry(location)
